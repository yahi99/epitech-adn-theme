...
var canvasDiv2 = document.getElementById('particle-canvas-mobile');
var options = {
    particleColor: '#fff',
    background: 'assets/images/adn/blank.gif',
    interactive: true,
    speed: 'medium',
    density: 'high'
};
var particleCanvas = new ParticleNetwork(canvasDiv, options);
var particleCanvas = new ParticleNetwork(canvasDiv2, options);