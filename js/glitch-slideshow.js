 ...
 */
{
    ...
    class Slide {
        ...
        layout() {
            //this.DOM.slideImg.insertBefore = `<div class='glitch__img' style='background-image: ${this.DOM.slideImg.style.backgroundImage};'></div>`.repeat(5);
    ...
    class GlitchSlideshow {
        ...
        navigate(dir) {
            ...
            this.glitch(this.slides[this.current], this.slides[newCurrent]).then(() => {
                ...
                this.DOM.slides[this.current].classList.remove('fadeIn');
                this.current = newCurrent;
                this.DOM.slides[this.current].classList.add('slide--current');
                this.DOM.slides[this.current].classList.add('fadeIn');
